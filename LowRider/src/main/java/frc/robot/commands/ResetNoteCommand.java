 ...
 */
public class ResetNoteCommand extends Command {
	 ...
	 *  
	 */
	public ResetNoteCommand(IntakeSubsystem intakeSubsystem, WristSubsystem wristSubsystem) {
	...
	public boolean isFinished() {
		return m_intakeSubsystem.noteIsPresent();
	}
