 ...
 */
public class TrapScoringCommand extends Command {
	 ...
	 */
	public TrapScoringCommand(IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem, WristSubsystem wristSubsystem) {
