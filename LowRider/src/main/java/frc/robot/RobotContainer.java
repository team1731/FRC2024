...
public class RobotContainer {
  ...
  public RobotContainer(
    ...
    if(driveSubsystem.isEnabled()){
      ...
      NamedCommands.registerCommand("SetWristLongShotC", new SequentialCommandGroup(new InstantCommand(() ->  wristSubsystem.moveWrist(26)) ));
      ...
      NamedCommands.registerCommand("SetWristRed1Shot6", new SequentialCommandGroup(new InstantCommand(() ->  wristSubsystem.moveWrist(27)) ));
